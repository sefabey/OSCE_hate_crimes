...
read_csv("data/2018/osce_hate_incidents_2018.csv") %>% 
    ...
    write_csv("data/2018/osce_hate_incidents_2018_wide.csv")

osce_data_wide <- read_csv("data/2018/osce_hate_incidents_2018_wide.csv")
osce_data_wide
